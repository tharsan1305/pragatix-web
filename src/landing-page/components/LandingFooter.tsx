...
export const LandingFooter: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-slate-900 text-slate-400 border-t border-slate-800 text-xs sm:text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left bg-slate-950/50 p-5 sm:p-6 rounded-2xl border border-slate-800/80">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 shrink-0">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white text-xs font-semibold border border-slate-700 transition-all shadow-xs"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 hover:text-white text-xs font-semibold border border-indigo-500/30 transition-all shadow-xs"
            >
        ...
        <div className="text-center text-slate-400 text-xs sm:text-sm leading-relaxed max-w-4xl mx-auto">
