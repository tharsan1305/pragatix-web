    ...
    <div className="flex flex-col min-h-full bg-slate-50 pb-20">
      <div className="bg-slate-900 px-6 pt-10 pb-5 shadow-md text-white flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="type-h4">Attendance Settings</h1>
            <p className="type-caption text-slate-400 mt-0.5">Select an academic year to configure attendance rules &amp; penalties</p>
          </div>
        </div>
      ...
      <div className="p-6 max-w-2xl mx-auto w-full space-y-4">
        <div className="bg-slate-900 p-6 rounded-2xl text-white shadow-sm flex items-center space-x-4 mb-2">
          ...
          <div>
            <h2 className="type-h5">Attendance Rules Engine</h2>
            <p className="type-caption text-slate-300 mt-0.5">Configure minimum cutoff %, daily absence penalty, and warning thresholds</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-slate-200 p-6 space-y-3">
            ...
            <button
              onClick={fetchYears}
              className="px-4 py-2 bg-teal-600 text-white rounded-xl type-btn hover:bg-teal-700 cursor-pointer"
            >
              Retry
            </button>
          </div>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="type-caption text-slate-500 mt-0.5">Configure Attendance Threshold &amp; Rules for {y.yearName}</p>
                </div>
              </div>
