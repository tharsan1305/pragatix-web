  ...
  if (loading) {
    return (
      <div className="p-8 max-w-6xl mx-auto flex flex-col items-center justify-center min-h-[400px]">
        ...
        <p className="type-body-sm text-slate-600 font-medium">Loading group details...</p>
      </div>
    );
  }
    ...
    return (
      <div className="p-8 max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl p-10 text-center border border-slate-200 shadow-sm flex flex-col items-center">
          ...
          <p className="type-body-sm text-slate-500 max-w-md mb-6">
            You are not assigned to any group yet. Please contact your Class Coordinator for team placement.
          </p>
          <button
            onClick={fetchMyGroup}
            className="type-btn inline-flex items-center px-5 py-2.5 bg-indigo-600 text-white rounded-xl shadow-md hover:bg-indigo-700 transition cursor-pointer"
          >
  ...
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto space-y-6 pb-32">
      ...
      <div className="bg-slate-900 text-white px-6 py-4 rounded-2xl shadow-md flex justify-between items-center">
        <h1 className="type-h4">My Team Leaderboard</h1>
      ...
      <div className="bg-gradient-to-br from-blue-800 to-blue-600 rounded-2xl p-6 text-white shadow-xl space-y-5">
        <div className="flex justify-between items-start">
          <h2 className="type-h3 tracking-tight">{teamName}</h2>
        ...
        <div className="flex justify-around items-center pt-2">
          <div className="flex flex-col items-center">
            ...
            <span className="type-fine text-white/70">Total Team XP</span>
          </div>

          <div className="flex flex-col items-center">
            <Users className="w-6 h-6 text-white/80 mb-1" />
            <span className="type-h4">{currentMembers} / {maxMembers}</span>
            <span className="type-fine text-white/70">Members</span>
          </div>
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {isCaptain && (
                          <span className="type-fine font-extrabold px-2 py-0.5 rounded-full bg-amber-400 text-slate-950 uppercase tracking-wider">
                            👑 CAPTAIN
                          </span>
                        )}
                        {isViceCaptain && (
                          <span className="type-fine font-extrabold px-2 py-0.5 rounded-full bg-slate-300 text-slate-900 uppercase tracking-wider">
                            🥈 VICE CAPTAIN
                          </span>
                        )}
                      </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0 ml-3">
                    <div className="flex items-center gap-1 type-body-sm font-extrabold text-amber-600">
            ...
            <div className="bg-white rounded-3xl max-w-lg w-full max-h-[85vh] flex flex-col shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="type-h4 text-slate-900">Add Classmates to Team</h3>
                    <p className="type-caption text-slate-500 font-medium">Select one or more classmates to join your team</p>
                  </div>
                </div>
                <button
              ...
              <div className="px-5 py-2.5 bg-indigo-50/50 border-b border-indigo-100/60 flex items-center justify-between type-caption">
                ...
                <span className={`font-bold px-2 py-0.5 rounded-full type-fine ${availableSlots > 0 ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>
              ...
              <div className="p-4 flex-1 flex flex-col overflow-hidden space-y-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-8 py-2 bg-slate-50 border border-slate-200 rounded-xl type-caption focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none"
                  />
                  {classmateSearchQuery && (
                    <button
                ...
                {!isClassmatesLoading && filteredClassmates.length > 0 && (
                  <div className="flex items-center justify-between type-caption px-1 border-b border-slate-100 pb-2">
                    <button
                      type="button"
                    ...
                    <span className="font-bold text-indigo-700 bg-indigo-50 px-2 py-0.5 rounded-full type-fine">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                              <div className="font-bold type-body-sm text-slate-800 truncate">{cName}</div>
                              <div className="type-caption text-slate-500 font-medium">{cRegNo}</div>
                            </div>
                          </div>
                          ...
                          <button
                            ...
                            className="type-btn px-3 py-1 bg-indigo-50 text-indigo-700 hover:bg-indigo-600 hover:text-white rounded-lg transition-colors cursor-pointer shrink-0 ml-2"
                          >
                ...
                <div className="flex justify-end gap-2 pt-3 border-t border-slate-100">
                  <button
                    type="button"
                    onClick={() => setIsAddModalOpen(false)}
                    className="type-btn px-4 py-2 text-slate-600 hover:bg-slate-100 rounded-xl cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="type-btn px-5 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5 cursor-pointer"
                  >
                    {isSubmittingMembers ? (
                      <>
