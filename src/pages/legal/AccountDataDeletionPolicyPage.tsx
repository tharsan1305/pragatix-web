  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-slate-900 text-white px-6 py-4 flex items-center shadow-md sticky top-0">
        ...
        <h1 className="text-lg font-bold">Account &amp; Data Deletion Policy</h1>
      </header>
      ...
      <main className="max-w-3xl mx-auto w-full p-6 my-8 bg-white rounded-3xl border border-slate-100 shadow-sm flex-1">
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 mb-2">Account &amp; Data Deletion Policy</h1>
        ...
        <h2 className="text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">1. Overview</h2>
        ...
        <h2 className="text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">2. Who Can Request Deletion</h2>
...
legal retention requirements.</div>
        ...
        <h2 className="text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">4. What Happens After You Submit a Request</h2>
        ...
        <h2 className="text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">5. What Gets Deleted vs. What Is Retained</h2>
        ...
        <h2 className="text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">6. Deletion Requests for Minors</h2>
        ...
        <h2 className="text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">7. Contact Us</h2>
