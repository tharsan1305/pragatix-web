  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-slate-900 text-white px-6 py-4 flex items-center shadow-md sticky top-0">
        ...
        <h1 className="type-h5 text-white">Account &amp; Data Deletion Policy</h1>
      </header>
      ...
      <main className="max-w-3xl mx-auto w-full p-6 my-8 bg-white rounded-3xl border border-slate-100 shadow-sm flex-1">
        ...
        <h1 className="type-h2 text-slate-900 mb-2">Account &amp; Data Deletion Policy</h1>
        ...
        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">1. Overview</h2>
        <p className="type-body-sm text-slate-600">This policy explains how you can request deletion of your PragatiX account and associated personal data, what happens after you submit a request, and what data may be retained even after deletion, in accordance with applicable law and academic record-keeping requirements.</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">2. Who Can Request Deletion</h2>
        <p className="type-body-sm text-slate-600">Any registered user of PragatiX - student, parent/guardian, teacher, or staff member - may request deletion of their account and personal data. For students under 18, a parent or guardian may submit the request on the student's behalf.</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">3. How to Request Account &amp; Data Deletion</h2>
        <p className="type-body-sm text-slate-600">To request deletion of your PragatiX account and associated personal data, please send an email to <strong>jjcetpm@jjcet.ac.in</strong> with the subject line <strong>"Account Deletion Request"</strong>, using the template below. Including all requested details helps us verify your account and process your request faster.</p>

        <div className="bg-slate-50 border border-slate-200 border-l-4 border-l-indigo-500 rounded-lg p-4 mt-4 type-body-sm font-mono whitespace-pre-wrap text-slate-700">To: jjcetpm@jjcet.ac.in
...
legal retention requirements.</div>
        ...
        <p className="type-body-sm text-slate-600 mt-4">Once we receive your request, we will verify your identity and take action within <strong>72 hours</strong>.</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">4. What Happens After You Submit a Request</h2>
        <ol className="list-decimal list-inside space-y-2 mb-4 type-body-sm text-slate-600">
        ...
        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">5. What Gets Deleted vs. What Is Retained</h2>
        <p className="type-body-sm text-slate-600"><strong>Deleted upon request (within 72 hours):</strong></p>
        ...
        <p className="type-body-sm text-slate-600"><strong>Retained even after account deletion (as required by academic and legal obligations):</strong></p>
        <ul className="list-disc list-inside space-y-2 mb-4 type-body-sm text-slate-600">
        ...
        <p className="type-body-sm text-slate-600">Where full deletion is not possible due to these obligations, we will anonymize the data where feasible, removing identifying information while retaining what is institutionally or legally required.</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">6. Deletion Requests for Minors</h2>
        <p className="type-body-sm text-slate-600">Where the user is under 18, deletion requests must be submitted by a parent or guardian. We may request proof of relationship to the student before processing the request.</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">7. Contact Us</h2>
        <p className="type-body-sm text-slate-600">For any questions regarding account or data deletion, mail us directly using the details below.</p>
        ...
        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">8. Changes to This Policy</h2>
        <p className="type-body-sm text-slate-600">We may update this policy periodically. The latest version will always be available on the PragatiX platform.</p>
