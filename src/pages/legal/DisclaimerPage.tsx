  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-slate-900 text-white px-6 py-4 flex items-center shadow-md sticky top-0">
        ...
        <h1 className="font-heading text-lg font-bold">Disclaimer</h1>
      </header>
      ...
      <main className="max-w-3xl mx-auto w-full p-6 my-8 bg-white rounded-3xl border border-slate-100 shadow-sm flex-1">
        ...
        <h1 className="font-heading text-2xl font-extrabold text-slate-900 mb-2">Disclaimer</h1>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">1. General Disclaimer</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">2. Academic and Discipline Data</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">3. No Professional or Legal Advice</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">4. Third-Party Services</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">5. System Availability</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">6. Notifications</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">7. User-Generated Content</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">8. Limitation of Liability</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">9. Changes to This Disclaimer</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">10. Contact</h2>
