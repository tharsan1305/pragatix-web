      ...
      <main className="max-w-3xl mx-auto w-full p-6 my-8 bg-white rounded-3xl border border-slate-100 shadow-sm flex-1">
        ...
        <div className="w-full border-collapse my-4 text-sm">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="bg-slate-50 text-slate-800 font-semibold p-2 border border-slate-200 text-left text-sm">Category</th>
                <th className="bg-slate-50 text-slate-800 font-semibold p-2 border border-slate-200 text-left text-sm">Retention</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Academic &amp; Discipline Records (marks, attendance, XP scores, complaints, rewards)</td>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Duration of enrollment and thereafter, as required for academic history, transcripts, verification, and legal obligations. Not deleted upon account deactivation.</td>
              </tr>
              <tr>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Session, Activity &amp; Technical Logs</td>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Up to 1 year from creation, then deleted, unless required longer for security investigation or legal compliance</td>
              </tr>
              <tr>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Parent/Guardian Mobile Numbers</td>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Retained only while needed for attendance SMS notifications, or as required by institutional policy</td>
              </tr>
              <tr>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Inactive Accounts</td>
                <td className="p-2 border border-slate-200 text-slate-600 text-sm">Deactivated (not immediately deleted) upon graduation, exit, or prolonged inactivity. Associated academic records continue to be retained per above.</td>
              </tr>
            </tbody>
          </table>
        </div>
