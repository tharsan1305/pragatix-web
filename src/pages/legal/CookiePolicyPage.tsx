  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-slate-900 text-white px-6 py-4 flex items-center shadow-md sticky top-0">
        ...
        <h1 className="type-h5 text-white">Cookie &amp; Tracking Policy</h1>
      </header>
      ...
      <main className="max-w-3xl mx-auto w-full p-6 my-8 bg-white rounded-3xl border border-slate-100 shadow-sm flex-1">
        ...
        <h1 className="type-h2 text-slate-900 mb-2">Cookie &amp; Tracking Policy</h1>
        ...
        <p className="type-body-sm text-slate-600 mb-6">This Cookie Policy explains how PragatiX ("we", "us", or "our") handles cookies and client-side storage mechanisms on our platform and applications (the "Platform").</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">1. What Are Cookies?</h2>
        <p className="type-body-sm text-slate-600">Cookies are small text files placed on your computer or mobile device when you visit a website. They are typically used to store state, track user browsing sessions, deliver advertisements, and gather analytics data across websites.</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">2. PragatiX Does Not Use Cookies</h2>
        <p className="type-body-sm text-slate-600">PragatiX does not set, deploy, or use cookies of any kind. Our platform is engineered on a stateless, token-based architecture. We do not write tracking data or session identifiers to your browser's cookie storage.</p>
        ...
        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">3. How Authentication &amp; Client-Side Storage Work</h2>
        <p className="type-body-sm text-slate-600">To allow you to securely log in and access your account, PragatiX uses stateless authentication via JSON Web Tokens (JWT):</p>
        <ul className="list-disc list-inside space-y-2 mb-4 type-body-sm text-slate-600">
        ...
        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">4. Managing Your Session &amp; Data</h2>
        <p className="type-body-sm text-slate-600">Because we do not use cookies, managing your session is simple:</p>
        <ul className="list-disc list-inside space-y-2 mb-4 type-body-sm text-slate-600">
        ...
        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">5. Changes to This Cookie Policy</h2>
        <p className="type-body-sm text-slate-600">We may revise this policy from time to time to reflect operational or legal updates. Any changes will be posted directly to this page with an updated "Last Updated" date.</p>

        <h2 className="type-h4 text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">6. Contact Us</h2>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
          <p className="type-body-sm text-slate-600 mb-1"><strong>Institution:</strong> J.J. College of Engineering and Technology</p>
