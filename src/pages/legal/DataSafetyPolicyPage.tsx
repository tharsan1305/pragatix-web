  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-slate-900 text-white px-6 py-4 flex items-center shadow-md sticky top-0">
        ...
        <h1 className="font-heading text-lg font-bold">Data Safety Policy</h1>
      </header>
      ...
      <main className="max-w-3xl mx-auto w-full p-6 my-8 bg-white rounded-3xl border border-slate-100 shadow-sm flex-1">
        ...
        <h1 className="font-heading text-2xl font-extrabold text-slate-900 mb-2">Data Safety Policy</h1>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">1. Does This App Collect or Share User Data?</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">2. Data Types Collected</h2>
        <h3 className="font-heading text-base font-bold text-slate-800 mt-4 mb-2">Personal Info</h3>
        ...
        <h3 className="font-heading text-base font-bold text-slate-800 mt-4 mb-2">Other Categories</h3>
        ...
        <h3 className="font-heading text-base font-bold text-slate-800 mt-4 mb-2">App Activity</h3>
        <ul className="list-disc list-inside space-y-2 mb-4 text-slate-600 text-sm">
        ...
        <h3 className="font-heading text-base font-bold text-slate-800 mt-4 mb-2">App Info and Performance</h3>
        <ul className="list-disc list-inside space-y-2 mb-4 text-slate-600 text-sm">
          <li>Crash logs - Collected - Optional - Analytics / stability</li>
          <li>Diagnostics - Collected - Optional - Analytics / stability</li>
        </ul>

        <h3 className="font-heading text-base font-bold text-slate-800 mt-4 mb-2">Device or Other IDs</h3>
        <ul className="list-disc list-inside space-y-2 mb-4 text-slate-600 text-sm">
          <li>Device or other IDs - Collected - Required - App functionality and security</li>
        </ul>

        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">3. Is Data Shared With Third Parties?</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">4. Is Data Encrypted in Transit?</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">5. Can Users Request Data Deletion?</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">6. Security Practices</h2>
        <ul className="list-disc list-inside space-y-2 mb-4 text-slate-600 text-sm">
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">7. Children's Data</h2>
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">8. Data Retention Summary</h2>
        <ul className="list-disc list-inside space-y-2 mb-4 text-slate-600 text-sm">
        ...
        <h2 className="font-heading text-lg font-bold text-slate-800 mt-6 mb-3 pb-2 border-b-2 border-slate-100">9. Contact</h2>
